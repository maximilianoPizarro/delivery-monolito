    ...
    <div class="col-8">
      <div v-if="producto">
        <h2 class="jh-entity-heading" data-cy="productoDetailsHeading">
          <span v-text="$t('pedidosrapiadminApp.producto.detail.title')">Producto</span> {{ producto.id }}
        </h2>
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-text="$t('pedidosrapiadminApp.Medida.' + producto.medida)">{{ producto.medida }}</span>
          </dd>
          <dt>
