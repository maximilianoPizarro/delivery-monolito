  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pedidosrapiadminApp.producto.home.createOrEditLabel"
          data-cy="ProductoCreateUpdateHeading"
          v-text="$t('pedidosrapiadminApp.producto.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.nombre')" for="producto-nombre">Nombre</label>
            <input
              type="text"
              class="form-control"
              name="nombre"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.description')" for="producto-description"
              >Description</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.precio')" for="producto-precio">Precio</label>
            <input
              type="number"
              class="form-control"
              name="precio"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.medida')" for="producto-medida">Medida</label>
            <select
              class="form-control"
              name="medida"
              ...
              required
            >
              <option value="S" v-bind:label="$t('pedidosrapiadminApp.Medida.S')">S</option>
              <option value="M" v-bind:label="$t('pedidosrapiadminApp.Medida.M')">M</option>
              <option value="L" v-bind:label="$t('pedidosrapiadminApp.Medida.L')">L</option>
              <option value="XL" v-bind:label="$t('pedidosrapiadminApp.Medida.XL')">XL</option>
              <option value="XXL" v-bind:label="$t('pedidosrapiadminApp.Medida.XXL')">XXL</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.image')" for="producto-image">Image</label>
            <div>
              <img
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.producto.productoCategoria')" for="producto-productoCategoria"
