  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pedidosrapiadminApp.productoOrden.home.createOrEditLabel"
          data-cy="ProductoOrdenCreateUpdateHeading"
          v-text="$t('pedidosrapiadminApp.productoOrden.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.productoOrden.cantidad')" for="producto-orden-cantidad"
              >Cantidad</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.productoOrden.precioTotal')" for="producto-orden-precioTotal"
              >Precio Total</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.productoOrden.producto')" for="producto-orden-producto"
              >Producto</label
            >
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.productoOrden.cart')" for="producto-orden-cart">Cart</label>
