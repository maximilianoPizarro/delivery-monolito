<template>
  <div>
    <h2 id="page-heading" data-cy="ClienteHeading">
      <span v-text="$t('pedidosrapiadminApp.cliente.home.title')" id="cliente-heading">Clientes</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('pedidosrapiadminApp.cliente.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ClienteCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('pedidosrapiadminApp.cliente.home.createLabel')"> Create a new Cliente </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clientes && clientes.length === 0">
      <span v-text="$t('pedidosrapiadminApp.cliente.home.notFound')">No clientes found</span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clientes">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('genero')">
              <span v-text="$t('pedidosrapiadminApp.cliente.genero')">Genero</span>
            ...
            <th scope="row" v-on:click="changeOrder('telefono')">
              <span v-text="$t('pedidosrapiadminApp.cliente.telefono')">Telefono</span>
            ...
            <th scope="row" v-on:click="changeOrder('direccion1')">
              <span v-text="$t('pedidosrapiadminApp.cliente.direccion1')">Direccion 1</span>
            ...
            <th scope="row" v-on:click="changeOrder('direccion2')">
              <span v-text="$t('pedidosrapiadminApp.cliente.direccion2')">Direccion 2</span>
            ...
            <th scope="row" v-on:click="changeOrder('ciudad')">
              <span v-text="$t('pedidosrapiadminApp.cliente.ciudad')">Ciudad</span>
            ...
            <th scope="row" v-on:click="changeOrder('pais')">
              <span v-text="$t('pedidosrapiadminApp.cliente.pais')">Pais</span>
            ...
            <th scope="row" v-on:click="changeOrder('user.login')">
              <span v-text="$t('pedidosrapiadminApp.cliente.user')">User</span>
        ...
        <tbody>
          <tr v-for="cliente in clientes" :key="cliente.id" data-cy="entityTable">
            ...
            <td v-text="$t('pedidosrapiadminApp.Genero.' + cliente.genero)">{{ cliente.genero }}</td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="pedidosrapiadminApp.cliente.delete.question" data-cy="clienteDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-cliente-heading" v-text="$t('pedidosrapiadminApp.cliente.delete.question', { id: removeId })">
