  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pedidosrapiadminApp.cliente.home.createOrEditLabel"
          data-cy="ClienteCreateUpdateHeading"
          v-text="$t('pedidosrapiadminApp.cliente.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.genero')" for="cliente-genero">Genero</label>
            <select
              class="form-control"
              name="genero"
              ...
              required
            >
              <option value="MASCULINO" v-bind:label="$t('pedidosrapiadminApp.Genero.MASCULINO')">MASCULINO</option>
              <option value="FEMENINO" v-bind:label="$t('pedidosrapiadminApp.Genero.FEMENINO')">FEMENINO</option>
              <option value="OTRO" v-bind:label="$t('pedidosrapiadminApp.Genero.OTRO')">OTRO</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.telefono')" for="cliente-telefono">Telefono</label>
            <input
              type="text"
              class="form-control"
              name="telefono"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.direccion1')" for="cliente-direccion1"
              >Direccion 1</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.direccion2')" for="cliente-direccion2"
              >Direccion 2</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.ciudad')" for="cliente-ciudad">Ciudad</label>
            <input
              type="text"
              class="form-control"
              name="ciudad"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.pais')" for="cliente-pais">Pais</label>
            <input
              type="text"
              class="form-control"
              name="pais"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.cliente.user')" for="cliente-user">User</label>
