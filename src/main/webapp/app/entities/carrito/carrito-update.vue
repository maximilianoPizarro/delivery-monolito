  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="pedidosrapiadminApp.carrito.home.createOrEditLabel"
          data-cy="CarritoCreateUpdateHeading"
          v-text="$t('pedidosrapiadminApp.carrito.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.fecha')" for="carrito-fecha">Fecha</label>
            <div class="d-flex">
              <input
                id="carrito-fecha"
                data-cy="fecha"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.status')" for="carrito-status">Status</label>
            <select
              class="form-control"
              name="status"
              ...
              required
            >
              <option value="COMPLETO" v-bind:label="$t('pedidosrapiadminApp.OrdenStatus.COMPLETO')">COMPLETO</option>
              <option value="PAGADO" v-bind:label="$t('pedidosrapiadminApp.OrdenStatus.PAGADO')">PAGADO</option>
              <option value="PENDIENTE" v-bind:label="$t('pedidosrapiadminApp.OrdenStatus.PENDIENTE')">PENDIENTE</option>
              <option value="CANCELADO" v-bind:label="$t('pedidosrapiadminApp.OrdenStatus.CANCELADO')">CANCELADO</option>
              <option value="RECHAZADO" v-bind:label="$t('pedidosrapiadminApp.OrdenStatus.RECHAZADO')">RECHAZADO</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.precioTotal')" for="carrito-precioTotal"
              >Precio Total</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.metodoDePago')" for="carrito-metodoDePago"
            ...
            <select
              ...
              required
            >
              <option value="EFECTIVO" v-bind:label="$t('pedidosrapiadminApp.MetodoDePago.EFECTIVO')">efectivo</option>
              <option value="CUPON" v-bind:label="$t('pedidosrapiadminApp.MetodoDePago.CUPON')">cupon</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.referencia')" for="carrito-referencia"
              >Referencia</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('pedidosrapiadminApp.carrito.cliente')" for="carrito-cliente">Cliente</label>
